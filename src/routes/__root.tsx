...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Agronomo a Corato (Puglia). Agricoltura di precisione, rilievi drone, progettazione agraria, agrivoltaico e finanza agevolata per aziende agricole." },
      { name: "author", content: "Studio Tecnico Agrotech" },
      { property: "og:title", content: "Studio Tecnico Agrotech — Dott. Agr. Michele Loiodice" },
      { property: "og:description", content: "Agronomo a Corato (Puglia). Agricoltura di precisione, rilievi drone, progettazione agraria, agrivoltaico e finanza agevolata per aziende agricole." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Studio Tecnico Agrotech — Dott. Agr. Michele Loiodice" },
      { name: "twitter:description", content: "Agronomo a Corato (Puglia). Agricoltura di precisione, rilievi drone, progettazione agraria, agrivoltaico e finanza agevolata per aziende agricole." },
